            ...
            BlockButtonWidget(
              onPressed: () {
                if (controller.choosenDoctor.value.fullName == null) {
                  Get.showSnackbar(
                      Ui.RemindSnackBar( message: "Bạn chưa chọn bác sĩ"));
                  return;
                }
        ...
        child: ListView(
          ...
          children: [
            ...
            Obx(() {
              ...
              ) : const Center(child: Text("Không có dịch vụ", style: TextStyle(color: Colors.black, fontSize: 18)),);
            }),
            BlockButtonWidget(
              onPressed: () {
                if (controller.chooseService.value.name == null) {
